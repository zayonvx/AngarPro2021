export const CALC_PRICE_LIST: string[] = [
  'Фундамент',
  'Металло-каркас',
  'Ограждения',
  'Ворота',
...
export const CALC_PAGE_NAMES: string[] = ['HIDE', 'SIZES', 'DETAILS', 'OPTIONS'];
export const CALC_REGIONS: { id: number; name: string; snow: number; wind?: number }[] = [
  { id: 1, name: 'Москва и область', snow: 3, wind: 1 },
  { id: 2, name: 'Санкт-Петербург', snow: 3, wind: 2 },
  { id: 3, name: 'Иваново', snow: 4, wind: 1 },
  { id: 4, name: 'Ярославль', snow: 4, wind: 1 },
  { id: 5, name: 'Нижний Новгород', snow: 4, wind: 1 },
  { id: 6, name: 'Рязань', snow: 3, wind: 1 },
  { id: 7, name: 'Волгоград', snow: 2, wind: 1 },
  { id: 8, name: 'Ростов-на-Дону', snow: 2, wind: 1 },
  { id: 9, name: 'Смоленск', snow: 3, wind: 1 },
  { id: 10, name: 'Воронеж', snow: 3, wind: 1 },
  { id: 11, name: 'Тула', snow: 3, wind: 1 },
];
...
export const CALC_ARCHITECTURAL_TYPES: { id: number; name: string; minWidth: number; maxWidth: number }[] = [
  { id: 1, name: 'Односкатный', minWidth: 5, maxWidth: 15 },
  { id: 2, name: 'Двухскатный', minWidth: 10, maxWidth: 36 },
  { id: 3, name: 'Двухпролетный', minWidth: 30, maxWidth: 50 },
];
export const CALC_FOUNDATION: { id: number; name: string; sectionArea?: number; thickness?: number }[] = [
  { id: 1, name: 'Без фундамента' },
  { id: 2, name: 'Стальные сваи' },
  { id: 3, name: 'Стальные сваи с ж/б ростверком', sectionArea: 0.175 },
  { id: 4, name: 'Монолитный, ленточный', sectionArea: 0.2 },
  { id: 5, name: 'Монолитная ж/б плита', thickness: 0.2 },
];
...
export const CALC_FLOOR: { type: { id: number; name: string }[]; grinding: { price: number } } = {
  type: [
    { id: 1, name: 'Без полов' },
    { id: 2, name: 'Монолит 100мм' },
    { id: 3, name: 'Монолит 150мм' },
    { id: 4, name: 'Монолит 200мм' },
  ],
  grinding: { price: 0 },
};
...
export const CALC_FENSES: { id: number; name: string }[] = [
  { id: 1, name: 'ПВХ-ткань (тент)' },
  { id: 2, name: 'Профнастил' },
  { id: 3, name: 'Сендвич-панель' },
];

export const CALC_TENT = {
  material: [
    { id: 1, name: 'ПВХ-ткань 650гр.' },
    { id: 2, name: 'ПВХ-ткань 900гр.' },
  ],
  insulation: [
...
export const CALC_PROFNASTIL = {
  roof: [
    { id: 1, name: 'НС-44, оцинкованный' },
    { id: 2, name: 'НС-44, с полимерным покрытием' },
    { id: 3, name: 'НС-44, с анти-конденсатным покрытием' },
  ],
  wall: [
    { id: 1, name: 'МП-20, оцинкованный' },
    { id: 2, name: 'МП-20, с полимерным покрытием' },
  ],
  consumptionK: 1.15,
};
export const CALC_SANDWICH = {
  ...
  type: [
    { id: 1, name: 'с базальтовым утеплителем' },
    { id: 2, name: 'с утеплителем PIR' },
    { id: 3, name: 'с утеплителем пенополистирол' },
  ],
  consumptionK: 1.1,
};
...
export const CALC_DOORS: { types: { id: number; name: string }[]; quantities: number[] } = {
  types: [
    { id: 0, name: 'Нет' },
...
export const CALC_WINDOW_PARAMS = { height: 1.2, horizontal_gap: 1 };
